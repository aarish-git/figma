    ...
    <div class="tab-content" id="tabContent">
      <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
        <div className="subcontent">
          ...
          <img className="stepper_desc_img" src={solar} alt="solar" />
        </div>
      </div>
      <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
         <div className="subcontent">
          ...
          <img className="stepper_desc_img" src={sunshine} alt="sunshine" />
        </div>
      </div>
      <div class="tab-pane fade" id="messages" role="tabpanel" aria-labelledby="messages-tab">
         <div className="subcontent">
          ...
          <img className="stepper_desc_img" src={shading} alt="shading" />
        </div>
      </div>
      <div class="tab-pane fade" id="settings" role="tabpanel" aria-labelledby="settings-tab">
         <div className="subcontent">
          ...
          <img className="stepper_desc_img" src={daylight} alt="daylight" />
        </div>
      </div>
      <div class="tab-pane fade" id="office" role="tabpanel" aria-labelledby="office-tab">
         <div className="subcontent">
          ...
          <img className="stepper_desc_img" src={summer} alt="summer" />
        </div>
      </div>
      <div class="tab-pane fade" id="cooling" role="tabpanel" aria-labelledby="cooling-tab">
         <div className="subcontent">
          ...
          <img className="stepper_desc_img" src={cooling} alt="cooling" />
        </div>
      </div>
      <div class="tab-pane fade" id="assessment" role="tabpanel" aria-labelledby="assessment-tab">
         <div className="subcontent">
          ...
          <img className="stepper_desc_img" src={assessment} alt="assessment" />
        </div>
      </div>
      <div class="tab-pane fade" id="analysis" role="tabpanel" aria-labelledby="analysis-tab">
         <div className="subcontent">
          ...
          <img className="stepper_desc_img" src={build} alt="build" />
        </div>
      </div>
      <div class="tab-pane fade" id="placement" role="tabpanel" aria-labelledby="placement-tab">
         <div className="subcontent">
          ...
          <img className="stepper_desc_img" src={weather} alt="weather" />
        </div>
      </div>
    </div>
   </div>
