...
export default function index() {
  return (
    <div>
      <section class="service5_d text-gray-600 body-font ">
        <div class="container mx-auto flex  md:flex-row flex-col items-center bg-gray-100">
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center ">
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900 capitalize">
              what can you do with this Leaftech's high-quality and detailed analytic services?
            </h1>
      ...
      <section class="service5_t text-gray-600 body-font ">
        <div class="container px-3 py-5 mx-auto items-center bg-gray-100">
          <div class="items-center text-left">
            <h3 class="title-font sm:text-3xl text-3xl mb-4 font-medium text-gray-900 capitalize">
              what can you do with this Leaftech's high-quality and detailed analytic services?
            </h3>
            <p class="mb-8 leading-relaxed">
              Chillwave portland ugh, knausgaard fam polaroid iPhone. Man braid.
            ...
            <div class="flex w-full md:justify-start justify-center text-center items-end">
              <div class="relative mr-4 md:w-full lg:w-full xl:w-1/2 w-2/4">
                <button class=" bg-gray-700 rounded border text-white border-slate-900 focus:ring-2 focus:ring-indigo-200 focus:bg-transparent focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out capitalize">
                  contact page
                </button>
              </div>
            </div>
