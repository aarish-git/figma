      ...
      <div className="text-gray-600 body-font project_first_content_block" style={{ background: "linear-gradient(89.82deg, #FFFFFF 0.23%, rgba(255, 255, 255, 0.555775) 45.36%, rgba(228, 233, 239, 0.5) 83.29%, #E4E9EF 97.33%)"}} >
        <div className="row md:flex-row flex-col items-center" style={{ marginTop: "21px" }}>
          <div className="col-lg-6  items-center">
            <span
              style={{ fontFamily: "Exo2-Regular", marginBottom: '16px' }}
              className="text-[#0087FF] uppercase font-bold my-3 font-[600] text-[24px]"
            >
              Projects
            </span>
            <h1
              style={{ fontFamily: "Exo2-Regular", marginBottom: '32px' }}
              className="text-[#2F2F2F] text-[58px] font-[700] font-bold "
            >
              Our success stories
            </h1>
            <p style={{fontFamily: "NunitoSans-Regular", width: '635px', marginBottom:'64px'}} className="text-[20px] font-[400] w-[400] leading-relaxed">
