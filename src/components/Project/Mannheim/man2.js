            ...
            <div className="flex">
              ...
              <h2
                ...
                <ul className="space-y-5">
                  <li className="flex space-x-4"><img className="h-fit project_icons" alt="sun" src={sun} /><p className="project_icon_text">High solar heat gain from the large glass façade</p></li>
                  <li className="flex space-x-4"><img className="h-fit project_icons" alt="Wind" src={Wind} /><p className="project_icon_text">A non-uniform airflow in the office area </p></li>
                  <li className="flex space-x-4">
                  <img className="h-fit project_icons" alt="Battery" src={Battery} /><p className="project_icon_text">Changes in the energy balance due to the inner courtyard..</p>
                  </li>
                </ul>
              </div>
