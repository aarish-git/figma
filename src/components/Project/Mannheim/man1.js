                  ...
                  <div className=" ">
                    <div className="flex flex-wrap space-x-14 ">
                      <div className="sm:2/3 space-y-2">
                        ...
                        <p className="leading-relaxed text-[14px]">Total building surface area</p>
                      </div>
                      <div className="sm:2/3 space-y-2">
                        <h2 style={{ fontFamily: "Exo2-Bold" }} className="title-font font-bold  text-[40px]">
                        ~9,000 €
                        </h2>
                        <p className="leading-relaxed text-[14px]">Total price</p>
                      </div>
                      <div className="sm:2/3 space-y-2">
                        <h2 style={{ fontFamily: "Exo2-Bold" }} className="title-font font-bold text-[40px]">
                        ~8,000 sqm
                        </h2>
                        <p className="leading-relaxed text-[14px]">Total project area</p>
                      </div>
