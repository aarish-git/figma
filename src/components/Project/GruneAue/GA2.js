            ...
            <div class="flex flex-col mb-10 lg:items-start items-center">
              ...
              <div class="flex-grow">
                ...
                <ul class="my-3 space-y-5">
                  <li class="flex space-x-3"><img class="h-fit project_icons"  alt ="Sun" src={Sun} /><p className="project_icon_text">Photovoltaic potential assessment</p> </li>
                  <li class="flex space-x-3"><img class="h-fit project_icons"  alt ="ChartLine" src={ChartLine} /><p className="project_icon_text">Data for optimal PV system layout.</p> </li>
                </ul>
              </div>
            </div>
          </div>
