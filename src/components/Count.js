    ...
    <div>
      <section class=" body-font">
        <div class="container flex  py-24 md:flex-row flex-col items-center ">
          <div class="container py-20 mx-auto  w-full">
            <div class="flex flex-col text-left w-full mb-20">
              <h1
                style={{ fontFamily: "Exo2-Regular" }}
                class=" text-[#2F2F2F] lg:text-[58px] font-[700] leading-[70px] mb-4"
              >
            ...
            <section class="body-font">
              <div class="container text-left mx-auto">
                ...
                <div class="flex flex-wrap  text-left w-1/2 ">
          ...
          <div class="absolute right-14 bottom-40 h-[500.1px] w-[780px] -mr-6">
            <img
